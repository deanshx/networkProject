...
while True:
    ...
    if message[0] == 'a':
        ...
        # Changing a single char in msgAMdataAB:
        sizeMsg = len(msgAMdataAB)
        char_index = (randint(0, sizeMsg))
        string.letter
        changing_to_char = random.choice(string.letters)
        msgAMdataAB[char_index] = changing_to_char
        # Finished changing a random char in DataAB
